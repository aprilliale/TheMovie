 ...
 */
public class TigaFragment extends Fragment implements TigaAdapter.ITigaAdapter {
    ArrayList<Result> mList = new ArrayList<>();
    TigaAdapter mAdapter;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = (RecyclerView) getView().findViewById(R.id.recyclerViewTiga);
        recyclerView.setLayoutManager(new LinearLayoutManager(this.getActivity()));
        mAdapter = new TigaAdapter(this.getActivity(), mList);
